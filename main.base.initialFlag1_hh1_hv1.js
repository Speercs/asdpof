var MainBaseInitialFlag1_hh1_hv1 = {
    ...
    run: function( rm ) {
        ...
        if( xx_base > 0 && yy_base > 0 && xx_halfv1 > 0 && yy_halfv1 > 0  ){
            ...
            if( xx && yy ){
                ...
                new RoomVisual(rm).text('hv1', new RoomPosition(xx_halfv2, yy_halfv2, rm),  {color: 'black', font: 0.5});
                // Game.rooms[rm].visual.circle(new RoomPosition(xx_lab, yy_lab, rm),    {fill: 'orange', radius: 0.55, stroke: 'orange'});
                // new RoomVisual(rm).text('1', new RoomPosition(xx_lab, yy_lab, rm),    {color: 'black', font: 0.5});
        ...
        return [ xx_base, yy_base, xx_halfv1, yy_halfv1, xx_halfv2, yy_halfv2 , ramp_cnt , priority, 'h', 'v'];

    }
};

module.exports = MainBaseInitialFlag1_hh1_hv1;
